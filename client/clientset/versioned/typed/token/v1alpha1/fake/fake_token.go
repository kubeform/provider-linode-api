...
type FakeTokens struct {
	Fake *FakeTokenV1alpha1
	ns   string
}

var tokensResource = schema.GroupVersionResource{Group: "token.linode.kubeform.com", Version: "v1alpha1", Resource: "tokens"}

var tokensKind = schema.GroupVersionKind{Group: "token.linode.kubeform.com", Version: "v1alpha1", Kind: "Token"}
