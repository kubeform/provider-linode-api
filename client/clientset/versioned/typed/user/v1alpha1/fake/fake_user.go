...
import (
	...
	v1alpha1 "kubeform.dev/provider-linode-api/apis/user/v1alpha1"
...
var usersResource = schema.GroupVersionResource{Group: "user.linode.kubeform.com", Version: "v1alpha1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "user.linode.kubeform.com", Version: "v1alpha1", Kind: "User"}
