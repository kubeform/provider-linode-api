...
var domainsResource = schema.GroupVersionResource{Group: "domain.linode.kubeform.com", Version: "v1alpha1", Resource: "domains"}

var domainsKind = schema.GroupVersionKind{Group: "domain.linode.kubeform.com", Version: "v1alpha1", Kind: "Domain"}
