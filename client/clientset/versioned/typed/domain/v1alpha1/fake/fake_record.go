...
var recordsResource = schema.GroupVersionResource{Group: "domain.linode.kubeform.com", Version: "v1alpha1", Resource: "records"}

var recordsKind = schema.GroupVersionKind{Group: "domain.linode.kubeform.com", Version: "v1alpha1", Kind: "Record"}
