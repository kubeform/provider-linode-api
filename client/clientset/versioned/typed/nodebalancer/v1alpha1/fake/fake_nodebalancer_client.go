...
import (
	v1alpha1 "kubeform.dev/provider-linode-api/client/clientset/versioned/typed/nodebalancer/v1alpha1"
...
func (c *FakeNodebalancerV1alpha1) Configs(namespace string) v1alpha1.ConfigInterface {
	return &FakeConfigs{c, namespace}
}

func (c *FakeNodebalancerV1alpha1) Nodes(namespace string) v1alpha1.NodeInterface {
