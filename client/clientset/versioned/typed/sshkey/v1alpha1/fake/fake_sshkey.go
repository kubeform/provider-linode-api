...
import (
	...
	v1alpha1 "kubeform.dev/provider-linode-api/apis/sshkey/v1alpha1"
...
type FakeSshkeys struct {
	Fake *FakeSshkeyV1alpha1
	ns   string
}

var sshkeysResource = schema.GroupVersionResource{Group: "sshkey.linode.kubeform.com", Version: "v1alpha1", Resource: "sshkeys"}

var sshkeysKind = schema.GroupVersionKind{Group: "sshkey.linode.kubeform.com", Version: "v1alpha1", Kind: "Sshkey"}
