...
type FakeRdnses struct {
	Fake *FakeRdnsV1alpha1
	ns   string
}

var rdnsesResource = schema.GroupVersionResource{Group: "rdns.linode.kubeform.com", Version: "v1alpha1", Resource: "rdnses"}

var rdnsesKind = schema.GroupVersionKind{Group: "rdns.linode.kubeform.com", Version: "v1alpha1", Kind: "Rdns"}
