	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NodebalancerV1alpha1().Nodes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NodebalancerV1alpha1().Nodes(namespace).Watch(context.TODO(), options)
			},
		},
		&nodebalancerv1alpha1.Node{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodebalancerv1alpha1.Node{}, f.defaultInformer)
}
