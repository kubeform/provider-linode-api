...
import (
	...
	v1alpha1 "kubeform.dev/provider-linode-api/client/listers/volume/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VolumeV1alpha1().Volumes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VolumeV1alpha1().Volumes(namespace).Watch(context.TODO(), options)
			},
		},
		&volumev1alpha1.Volume{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&volumev1alpha1.Volume{}, f.defaultInformer)
}
