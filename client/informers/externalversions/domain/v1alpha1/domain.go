...
import (
	...
	v1alpha1 "kubeform.dev/provider-linode-api/client/listers/domain/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DomainV1alpha1().Domains(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DomainV1alpha1().Domains(namespace).Watch(context.TODO(), options)
			},
		},
		&domainv1alpha1.Domain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *domainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&domainv1alpha1.Domain{}, f.defaultInformer)
}
