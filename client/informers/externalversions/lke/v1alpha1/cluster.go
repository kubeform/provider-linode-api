...
import (
	...
	v1alpha1 "kubeform.dev/provider-linode-api/client/listers/lke/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LkeV1alpha1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LkeV1alpha1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&lkev1alpha1.Cluster{},
		resyncPeriod,
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lkev1alpha1.Cluster{}, f.defaultInformer)
}
