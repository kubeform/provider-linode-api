...
import (
	...
	v1alpha1 "kubeform.dev/provider-linode-api/client/listers/image/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ImageV1alpha1().Images(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ImageV1alpha1().Images(namespace).Watch(context.TODO(), options)
			},
		},
		&imagev1alpha1.Image{},
		resyncPeriod,
...
func (f *imageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&imagev1alpha1.Image{}, f.defaultInformer)
}
