...
import (
	...
	v1alpha1 "kubeform.dev/provider-linode-api/client/listers/token/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TokenV1alpha1().Tokens(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TokenV1alpha1().Tokens(namespace).Watch(context.TODO(), options)
			},
		},
		&tokenv1alpha1.Token{},
		resyncPeriod,
...
func (f *tokenInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tokenv1alpha1.Token{}, f.defaultInformer)
}
